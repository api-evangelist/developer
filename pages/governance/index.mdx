...
API Evangelist stack. Same engines (Spectral, the 769-rule best-of-breed catalog, the
...
```json
{
  ...
  "ruleCount": 461,
  "passed": false,
  "summary": { "error": 2, "warning": 8, "info": 0, "hint": 0, "total": 10 },
  "diagnostics": [ { "code": "info-contact", "message": "Info object must have \"contact\" object.", "severity": "warning", "path": ["info"] } ]
}
```
...
| `GET /governance/rules` | Free | The 769-rule best-of-breed catalog. |
